"""Build structured toxicity mechanism chains from retrieved evidence."""
...
class MechanismChainBuilder:
    """Converts tool evidence into the single supported causal-chain template."""
    ...
    def _fallback_chain(
        ...
        *,
        ...
        return MechanismChain(
            ...
            evidence=[
                MechanismEvidence(
                    source="PersAgent fallback chain builder",
                    tier=5,
