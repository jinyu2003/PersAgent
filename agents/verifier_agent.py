"""Verifier Agent with deterministic rules and lightweight consistency checks."""
...
from models.schemas import DrugInfo, EvidencePackage, ORGAN_SYSTEMS, PatientInfo, VerificationIssue, VerificationReport


class VerifierAgent:
    system_prompt = (
        "You are the Verifier Agent. Independently validate report structure, "
    ...
    def verify(
        ...
        summary = {
            "PASS": "All verifier layers passed.",
            "FLAGGED": "Verifier found non-blocking issues that require review.",
            "BLOCKED": "Verifier found a deterministic safety redline or critical missing field.",
        }[status]
